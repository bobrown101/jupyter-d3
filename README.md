...
run """jupyter notebook""" at the base of this project
...
The only thing I have not figured out is how to remove the script from being printed above
the graph, forcing you to scroll down past it to see the graph.
